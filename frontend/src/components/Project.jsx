...
const Project = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Full-stack real-time ride-sharing platform with rider and driver workflows, live driver tracking, pickup-to-destination navigation, OTP-based ride verification, fare calculation, ride cancellation, trip history, and Socket.IO-powered driver dispatch.",
      tags: [
        "React.js",
        "Node.js",
        "Express.js",
      ...
      githubUrl: "https://github.com/ruturaj1010/LiveRideSharing",
